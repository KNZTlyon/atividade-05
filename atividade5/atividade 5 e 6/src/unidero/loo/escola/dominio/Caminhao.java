...
public class Caminhao extends Aviao {
    ...
    public Caminhao(int codigo, int anoFabricado, int eixos, int assentos, int rodas, int qntdMotores,
        ...
        super(codigo, anoFabricado, eixos, assentos, rodas, qntdMotores, qntdOcupantes, nome, anoModelo, cor,
                ...
                pesoLiquido, pesoTotal, potencia, portas, atdeOcupantes);
        eixos = eixos2;
        this.codigoRenavam = codigoRenavam;
    }
